...
const CATEGORIA_DEFS = [
  ...
  { key: 'sticker', match: [/^sticker-/i, /^(st|stk)\.js$/i, /^(glitter|grafiti|moji|attp)/i] },
...
const CMD_EMOJI = {
  ...
  st: '🏷️', stk: '🏷️', sticker: '🏷️', tgs: '🎭', emojimix: '😜', gif: '🎞️',
  dado: '🎲', dados: '🎲', dadu: '🎲',
  ...
  to: '🔄', togifaud: '🎞️', ttsc: '🔊', tts2: '🔊', voz: '🔊', topdf: '📄', toanime: '🎨', toonce: '🎤',
  gimage: '🖼️', image: '🖼️', imagen: '🖼️', igstory: '📸', ighistoria: '📸',
  ...
  efectos: '📋', logos: '🎨', licencia: '🪪', hornycard: '📞',
  piropo: '💘', consejo: '🧠', fraseromantica: '💌', historiaromantica: '📖',
  kpop: '🎤', cristianoronaldo: '⚽', messi: '⚽', cat: '🐱', dog: '🐶', itzy: '🎶', blackpink: '🎀', navidad: '🎄', wpmontaña: '🏔️', wpmontana: '🏔️', pubg: '🔫', wpgaming: '🎮', wpaesthetic: '🌅', wpaesthetic2: '🌇', wprandom: '🎲', wallhp: '📱', wpvehiculo: '🚗', wpmoto: '🏍️', coffee: '☕', pentol: '😀', caricatura: '🎨', ciberespacio: '🌌', technology: '🧠', doraemon: '🐱', hacker: '👾', planeta: '🪐', randomprofile: '👤',
...
const FEATURED_CMDS = {
  ...
  maker: ['blur', 'pixelar', 'simpcard', 'lolice', 'itssostupid', 'licencia', 'logos', 'efectos', 'ytcomment', 'hornycard', 'setnamebot'],
  random: ['kpop', 'cristianoronaldo', 'messi', 'cat', 'dog', 'itzy', 'blackpink', 'navidad', 'wpmontaña', 'pubg', 'wpgaming', 'wpaesthetic', 'wpaesthetic2', 'wprandom', 'wallhp', 'wpvehiculo', 'wpmoto', 'coffee', 'pentol', 'caricatura', 'ciberespacio', 'technology', 'doraemon', 'hacker', 'planeta', 'randomprofile'],
  convertidor: ['togifaud', 'toimg', 'tomp3', 'toptt', 'tovideo', 'tourl', 'tts2', 'img', 'to', 'topdf'],
