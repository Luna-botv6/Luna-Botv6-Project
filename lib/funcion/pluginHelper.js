...
// El caché de group_admins.json se mantiene actualizado en tiempo real vía
// eventos promote/demote (ver addAdminToCache/removeAdminFromCache llamados
// desde groupMetadata.js). Una vez que existe una entrada para el chat, es
// más confiable que el array `participants` de global.groupCache, que solo
// se refresca cuando fetchMetadata() logra pegarle en vivo a WhatsApp (algo
// que casi no pasa salvo justo después de un reinicio). Si todavía no hay
// entrada para el chat, se devuelve null y el llamador debe usar el valor
// calculado desde participants como fallback.
