...
// Función para eliminar protección específica (para uso del sistema de hackeo)
export function eliminarProteccion(userId) {
  limpiarProtecciones()
  if (proteccionesActivas[userId]) {
    delete proteccionesActivas[userId]
    saveProtecciones()
    return true
  }
  return false
