...
const handler = async (m, { conn, args, usedPrefix }) => {
  ...
  const res = await fetch('https://api.github.com/repos/Luna-botv6/Luna-Botv6-Project');
  ...
  txt += `${tradutor.texto1[11]}\n_${usedPrefix}gitclone ${json?.html_url || 'https://github.com/Luna-botv6/Luna-Botv6-Project'}_`;
  await conn.sendMessage(m.chat, { text: txt.trim(), mentions: [...txt.matchAll(/@([0-9]{5,16}|0)/g)].map((v) => v[1] + '@s.whatsapp.net'), contextInfo: { forwardingScore: 9999999, isForwarded: true, mentionedJid: [...txt.matchAll(/@([0-9]{5,16}|0)/g)].map((v) => v[1] + '@s.whatsapp.net'), 'externalAdReply': { 'showAdAttribution': true, 'containsAutoReply': true, 'renderLargerThumbnail': true, 'title': global.titulowm2, 'mediaType': 1, 'thumbnail': imagen4, 'mediaUrl': 'https://whatsapp.com/channel/0029VbANyNuLo4hedEWlvJ3Y', 'sourceUrl': 'https://whatsapp.com/channel/0029VbANyNuLo4hedEWlvJ3Y' } } }, { quoted: m });
};
