...
`https://saucenao.com/search.php?db=999&output_type=2&testmode=1&numres=6&api_key=${apiKey}&url=${encodeURIComponent(url)}`
)
success = true;
break;
} catch (error) {}
...
case 'author_name': propName = 'Nombre del Autor'; break
case 'author_url': propName = 'URL del Autor'; break
default: propName = prop
}
...
groupName: "P",
caption: " ",
jpegThumbnail: await (await fetch(primerResultado.header.thumbnail)).buffer()
}
}
}
...
await m.reply("Ocurrió un error inesperado al procesar la solicitud.")
